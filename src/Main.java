public class Main {
    public static void test_lexer()
    {
        ...
        String[] strings = {
                ...
                "int main(){return/*block/*/}",//识别成功
                "int //annotation\nmain(){return 0;}",//识别成功
                "int main(){return 0;}//annotation",//识别成功
                "int main(){return/*annotation block}",//块注释报错
        };
        for(int i=0;i<strings.length;i++)
        {
            ...
            for(int j=0;j<Lexer.token_list.size();j++)
            {
                System.out.print("\""+Lexer.token_list.elementAt(j).lexeme+"\"");
                if(j != Lexer.token_list.size() - 1)
                    System.out.print(",");
            }
            System.out.println("]");
        }
