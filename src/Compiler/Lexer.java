    ...
    private static Token get_next_token()
    {
        ...
        try
        {
            ...
            if(Character.isAlphabetic(current_char) || current_char == '_')
            {
                ...
                rollback();
                //关键字
                if(identifier_string.toString().equals("int"))
                    return new Token(Token_type.Token_int,identifier_string.toString(),line,column);
                if(identifier_string.toString().equals("float"))
                    return new Token(Token_type.Token_float,identifier_string.toString(),line,column);
                if(identifier_string.toString().equals("bool"))
                    return new Token(Token_type.Token_bool,identifier_string.toString(),line,column);
                if(identifier_string.toString().equals("void"))
                    return new Token(Token_type.Token_void,identifier_string.toString(),line,column);
                if(identifier_string.toString().equals("char"))
                    return new Token(Token_type.Token_char,identifier_string.toString(),line,column);
                if(identifier_string.toString().equals("true") || identifier_string.toString().equals("false"))
                    return new Token(Token_type.Token_bool_literal,identifier_string.toString(),line,column);
                if(identifier_string.toString().equals("return"))
                    return new Token(Token_type.Token_return,identifier_string.toString(),line,column);
                if(identifier_string.toString().equals("if"))
                    return new Token(Token_type.Token_if,identifier_string.toString(),line,column);
                if(identifier_string.toString().equals("else"))
                ...
                if(identifier_string.toString().equals("break"))
                    return new Token(Token_type.Token_break,identifier_string.toString(),line,column);
                if(identifier_string.toString().equals("continue"))
                    return new Token(Token_type.Token_continue,identifier_string.toString(),line,column);
                if(identifier_string.toString().equals("print"))
                    return new Token(Token_type.Token_print,identifier_string.toString(),line,column);
                if(identifier_string.toString().equals("const"))
                    return new Token(Token_type.Token_const,identifier_string.toString(),line,column);
                // 普通标识符
                return new Token(Token_type.Token_id,identifier_string.toString(),line,column);
            }
            // 运算符或分隔符
            switch (current_char) {
                case '+' -> {
